...
import com.kaodim.design.components.calendarView.utils.inflate
import com.kaodim.design.components.calendarView.utils.orZero
    ...
    fun notifyMonthScrollListenerIfNeeded() {
        ...
        if (visibleItemPos != androidx.recyclerview.widget.RecyclerView.NO_POSITION) {
            ...
            if (visibleMonth != this.visibleMonth) {
                ...
                // view will end up having a blank space at the bottom unless the immediate previous and n«ext
